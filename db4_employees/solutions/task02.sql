...
SELECT
    ...
    (SELECT COUNT(*) FROM tasks t WHERE t.assignedto = e.employeeid) AS totaltasks,
    (SELECT COUNT(*) FROM employees sub WHERE sub.managerid = e.employeeid) AS totalsubordinates
FROM subordinates s
